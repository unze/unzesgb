...
if($logged == "1"){ print '<font color="red"><center>Sie haben einen falschen Benutzernamen oder Passwort eingegeben,<br>achten Sie auf Groß- und Kleinschriebung!</center></font>'; }
...
<div align="center">
  <center>
    <table border="0" cellpadding="2" cellspacing="1" width="333" bgcolor="#46A0E3">
       ...
       <tr>
         <td bgcolor="#FFFFFF"><input type="reset" value="löschen" name="löschen"></td>
